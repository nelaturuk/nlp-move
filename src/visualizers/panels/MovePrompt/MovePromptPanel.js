...
define([
    ...
    'common/util/guid',
    '../ReactVisualizerBundles/MovePrompt.reactViz.bundle'
  ], function (CONSTANTS,
    PanelBase,
    IActivePanel,
    guid,
    ...
    function MovePromptPanel (layoutManager, params) {
      const options = {}
      // set properties from options
      options[PanelBase.OPTIONS.LOGGER_INSTANCE_NAME] = 'MovePromptPanel'
    ...
    _.extend(MovePromptPanel.prototype, PanelBase.prototype)
    _.extend(MovePromptPanel.prototype, IActivePanel.prototype)
  
    MovePromptPanel.prototype.initialize = function initialize () {
    ...
    MovePromptPanel.prototype.afterAppend = function afterAppend () {
      reactViz(this.appId)
    }
  
    MovePromptPanel.prototype.onReadOnlyChanged = function onReadOnlyChanged (isReadOnly) {
      // apply parent's onReadOnlyChanged
      PanelBase.prototype.onReadOnlyChanged.call(this, isReadOnly)
      this.stateMediator.onReadOnlyChanged(isReadOnly)
    }
  
    MovePromptPanel.prototype.onResize = function onResize (width, height) {
      this.stateMediator.onResize(width, height)
    }
  
    MovePromptPanel.prototype.stateActiveObjectChanged = function stateActiveObjectChanged (model, activeNode) {
    ...
    MovePromptPanel.prototype.stateActiveSelectionChanged = function stateActiveSelectionChanged (model, activeSelection) {
      this.stateMediator.onActiveSelectionChange(activeSelection)
    }
  
    /* * * * * * * * Visualizer life cycle callbacks * * * * * * * */
    MovePromptPanel.prototype.attachClientEventListeners = function attachClientEventListeners () {
    ...
    MovePromptPanel.prototype.detachClientEventListeners = function detachClientEventListeners () {
    ...
    MovePromptPanel.prototype.destroy = function destroy () {
      this.detachClientEventListeners()
    ...
    MovePromptPanel.prototype.onActivate = function onActivate () {
    ...
    MovePromptPanel.prototype.onDeactivate = function onDeactivate () {
      this.detachClientEventListeners()
      this.stateMediator.onDeactivate()
    }
  
    return MovePromptPanel
  })
